package com.mataca.sholatyuk.network.api

import com.mataca.sholatyuk.BuildConfig
import com.mataca.sholatyuk.model.DataJadwalSholat
import com.mataca.sholatyuk.model.DataKota
...
object ShalatClient {
    ...
    fun getCityData(): Deferred<DataKota> {
        return async(CommonPool) {
            val request = Request.Builder()
                    .url(BuildConfig.BASE_URL + "/jadwal-sholat/get-kota")
                    .build()
    ...
    fun getPrayerScheduleData(id: Int): Deferred<DataJadwalSholat> {
        return async(CommonPool) {
            var url = BuildConfig.BASE_URL + "/jadwal-sholat"
